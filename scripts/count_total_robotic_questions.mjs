...
console.log('🔍 TOTAL COUNT OF ALL BOILERPLATE / TEMPLATE QUESTIONS ACROSS DATABASE...');
...
console.log(`Total robotic template questions found in DB: ${badQuestions.length}`);

const countBySub = {};
badQuestions.forEach(q => {
  countBySub[q.subject_id] = (countBySub[q.subject_id] || 0) + 1;
});
console.log('Breakdown of robotic questions by subject:', countBySub);
