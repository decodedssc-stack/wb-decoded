...
const feb2026Events = [
  // =========================================================================
  // 1. WEST BENGAL & EAST INDIA SPECIAL (FEBRUARY 2026)
  // =========================================================================
  {
  ...
  // =========================================================================
  // 2. UNION BUDGET 2026–27 & NATIONAL SCHEMES (10 EVENTS)
  // =========================================================================
  {
  ...
  // =========================================================================
  // 6. DEFENSE, MILITARY EXERCISES & NAVAL OPERATIONS (12 EVENTS)
  // =========================================================================
  {
  ...
  // =========================================================================
  // 7. SPACE, FRONTIER SCIENCE & HEALTH TECH (10 EVENTS)
  // =========================================================================
  {
  ...
  // =========================================================================
  // 9. AWARDS, HONORS & RECOGNITIONS (12 EVENTS)
  // =========================================================================
  {
  ...
  // =========================================================================
  // 12. ENVIRONMENT, WILDLIFE & WETLANDS (8 EVENTS)
  // =========================================================================
  {
  ...
  },
  {
    ...
    keyPoints: ['India added Patna Bird Sanctuary (UP) and Chhari-Dhand (Gujarat) on this day.'],
    staticGk: {
  ...
  },
  {
    ...
    keyPoints: ['Promotes HPV vaccination for cervical cancer prevention and tobacco cessation.'],
    staticGk: {
  ...
  },
  {
    ...
    keyPoints: ['Aims to achieve total eradication of FGM by 2030 in line with UN Sustainable Development Goals.'],
    staticGk: {
  ...
  },
  {
    ...
    keyPoints: ['ILO spearheads the Global Coalition for Social Justice.'],
    staticGk: {
  ...
  },
  {
    ...
    keyPoints: ['Honours contribution of excise and customs revenue toward nation-building and border vigilance.'],
    staticGk: {
...
const fileContent = fileHeader + JSON.stringify(feb2026Events, null, 2) + ';\n';
fs.writeFileSync(path.resolve('src/data/februaryMegaCompendium.ts'), fileContent, 'utf-8');
console.log('Successfully written pure, verified 2026 February compendium! Total Count:', feb2026Events.length);
